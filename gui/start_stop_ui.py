...
class Ui_Frame(object):
    ...
    def retranslateUi(self, Frame):
        ...
        item.setText(_translate("Frame", "Acc X"))
        item = self.tableWidget.verticalHeaderItem(1)
        item.setText(_translate("Frame", "Acc Y"))
        item = self.tableWidget.verticalHeaderItem(2)
        item.setText(_translate("Frame", "Acc Z"))
        item = self.tableWidget.verticalHeaderItem(3)
        item.setText(_translate("Frame", "Mag X"))
        item = self.tableWidget.verticalHeaderItem(4)
        item.setText(_translate("Frame", "Mag Y"))
        item = self.tableWidget.verticalHeaderItem(5)
        item.setText(_translate("Frame", "Mag Z"))
